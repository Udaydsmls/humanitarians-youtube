# BUILD-PROMPT — Archetype Engine. (Komal · 4K)

```
Build the claude-liam ai-explainer "Archetype Engine."
(slug: claude-liam-jungian-archetypes) — creator cut for Komal.

Ground truth:
1. humanitarians-youtube/claude-for-branding/youtube/claude-liam-jungian-archetypes/beat_sheet.json
...
4. 9:16 companion: short/beat_sheet.json
   B03 uses library BrandArchetypeWheel.
