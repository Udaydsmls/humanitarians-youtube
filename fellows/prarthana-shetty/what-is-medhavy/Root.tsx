...
import {
  ...
  LearnerMemory,
  InstructorIntro,
  CoInstructorPipeline,
  CourseCreationProblem,
  CourseImportPipeline,
  MedhavyClose,
  medhavyExplainerSchema,
} from './scenes/MedhavyExplainerScenes';
...
export const RemotionRoot: React.FC = () => {
  return (
    <>
      ...
      {/* ── Medhavy product explainer — What Is Medhavy? ── */}
      <Composition id="MedhavyHook" component={MedhavyHook} durationInFrames={450} fps={30} width={1920} height={1080} schema={medhavyExplainerSchema} defaultProps={{sparkLine: 'A textbook that teaches.', onScreenText: ['E-book', 'AI chatbot', 'What if both worked together?']}} />
      <Composition id="MedhavyBookTutor" component={MedhavyBookTutor} durationInFrames={450} fps={30} width={1920} height={1080} schema={medhavyExplainerSchema} defaultProps={{sparkLine: 'The tutor lives inside.', onScreenText: ['Online textbook', 'Built-in AI tutor']}} />
      <Composition id="MedhavyHub" component={MedhavyHub} durationInFrames={630} fps={30} width={1920} height={1080} schema={medhavyExplainerSchema} defaultProps={{sparkLine: 'One learning hub.', onScreenText: ['Physics', 'Cancer Biology', 'Quantum Mechanics', 'Electron Microscopy']}} />
      <Composition id="GenericChatbotRisk" component={GenericChatbotRisk} durationInFrames={480} fps={30} width={1920} height={1080} schema={medhavyExplainerSchema} defaultProps={{sparkLine: 'Anything can sound right.', onScreenText: ['Generic chatbot', 'Answers anything']}} />
      <Composition id="GroundedTutor" component={GroundedTutor} durationInFrames={600} fps={30} width={1920} height={1080} schema={medhavyExplainerSchema} defaultProps={{sparkLine: 'Grounded in the book.', onScreenText: ['Specific textbook', 'Actual chapter content', 'Grounded answer']}} />
      <Composition id="LearningPaths" component={LearningPaths} durationInFrames={510} fps={30} width={1920} height={1080} schema={medhavyExplainerSchema} defaultProps={{sparkLine: 'Different learners. Different paths.', onScreenText: ['Visual', 'Step by step', 'Questions']}} />
      <Composition id="LearnerMemory" component={LearnerMemory} durationInFrames={660} fps={30} width={1920} height={1080} schema={medhavyExplainerSchema} defaultProps={{sparkLine: 'The tutor adapts.', onScreenText: ['Learner Memory', 'Adapts over time']}} />
      <Composition id="InstructorIntro" component={InstructorIntro} durationInFrames={240} fps={30} width={1920} height={1080} schema={medhavyExplainerSchema} defaultProps={{sparkLine: 'Built for instructors too.', onScreenText: ['For instructors']}} />
      <Composition id="CoInstructorPipeline" component={CoInstructorPipeline} durationInFrames={780} fps={30} width={1920} height={1080} schema={medhavyExplainerSchema} defaultProps={{sparkLine: 'From material to teaching tools.', onScreenText: ['Summaries', 'Quizzes', 'Exams', 'Lecture notes']}} />
      <Composition id="CourseCreationProblem" component={CourseCreationProblem} durationInFrames={420} fps={30} width={1920} height={1080} schema={medhavyExplainerSchema} defaultProps={{sparkLine: 'Course building takes time.', onScreenText: ['Build from scratch', 'Time intensive']}} />
      <Composition id="CourseImportPipeline" component={CourseImportPipeline} durationInFrames={690} fps={30} width={1920} height={1080} schema={medhavyExplainerSchema} defaultProps={{sparkLine: 'Source in. Course out.', onScreenText: ['Textbook', 'GitHub repo', 'Course modules', 'Assessments']}} />
      <Composition id="MedhavyClose" component={MedhavyClose} durationInFrames={330} fps={30} width={1920} height={1080} schema={medhavyExplainerSchema} defaultProps={{sparkLine: 'A textbook that teaches back.', onScreenText: ['Personalized', 'Grounded', 'Built for learning']}} />
